...
import ZShoppingCard from '@/components/Elements/zCards/ZShoppingCard';
import {
  ZRUBox,
  ZRUButton,
  ZRUDropdownMenu,
    ...
    <>
      {is900pxScale ? (
        ...
        >
          ...
          >
            <ZSearchSvg className='w-8 h-8 px-1 text-medium' />
          </ZRUInputSlot>
        </ZRUInput>
      ) : isBelow900pxScale ? (
        <div className='me-2 ms-auto'>
          <ZRUDropdownMenu
            trigger={{
              children: <ZSearchSvg className='w-7 h-7 text-dark' />
            }}
          >
            <ZRUInput
              className='flex-1'
